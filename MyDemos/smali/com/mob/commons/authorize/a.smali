...
.method private final a(Landroid/content/Context;Lcom/mob/commons/authorize/MobProduct;Ljava/util/HashMap;Z)Ljava/lang/String;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/content/Context;",
            "Lcom/mob/commons/authorize/MobProduct;",
            "Ljava/util/HashMap",
            "<",
            "Ljava/lang/String;",
            "Ljava/lang/Object;",
...
.method private final a(Landroid/content/Context;Lcom/mob/commons/authorize/MobProduct;Ljava/util/HashMap;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2}, Lcom/mob/commons/authorize/MobProduct;->getProductTag()Ljava/lang/String;
    ...
    invoke-interface {p2}, Lcom/mob/commons/authorize/MobProduct;->getProductAppkey()Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2, p3, v1}, Lcom/mob/commons/authorize/a;->a(Landroid/content/Context;Lcom/mob/commons/authorize/MobProduct;Ljava/util/HashMap;Z)Ljava/lang/String;
...
.method private final b(Landroid/content/Context;Lcom/mob/commons/authorize/MobProduct;)Ljava/lang/String;
    .locals 6
    ...
    invoke-direct {p0, p1, p2}, Lcom/mob/commons/authorize/a;->c(Landroid/content/Context;Lcom/mob/commons/authorize/MobProduct;)Ljava/util/HashMap;
    ...
    invoke-direct {p0, p1, p2, v3, v1}, Lcom/mob/commons/authorize/a;->a(Landroid/content/Context;Lcom/mob/commons/authorize/MobProduct;Ljava/util/HashMap;Z)Ljava/lang/String;
    :try_end_4
    ...
    :cond_2
    invoke-direct {p0, p1, p2, v3}, Lcom/mob/commons/authorize/a;->a(Landroid/content/Context;Lcom/mob/commons/authorize/MobProduct;Ljava/util/HashMap;)V
    :try_end_5
...
.method private final c(Landroid/content/Context;Lcom/mob/commons/authorize/MobProduct;)Ljava/util/HashMap;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public final declared-synchronized a(Landroid/content/Context;Lcom/mob/commons/authorize/MobProduct;)Ljava/lang/String;
    .locals 3
    ...
    invoke-virtual {v1, v0}, Lcom/mob/tools/utils/FileLocker;->setLockFile(Ljava/lang/String;)V

    const/4 v0, 0x1

    invoke-virtual {v1, v0}, Lcom/mob/tools/utils/FileLocker;->lock(Z)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-direct {p0, p1, p2}, Lcom/mob/commons/authorize/a;->b(Landroid/content/Context;Lcom/mob/commons/authorize/MobProduct;)Ljava/lang/String;
