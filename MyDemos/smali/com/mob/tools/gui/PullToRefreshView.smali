...
.method static synthetic access$000(Lcom/mob/tools/gui/PullToRefreshView;)V
    .locals 0
    .param p0, "x0"    # Lcom/mob/tools/gui/PullToRefreshView;
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput v1, p0, Lcom/mob/tools/gui/PullToRefreshView;->downY:F
    ...
    invoke-virtual {v1, v4}, Lcom/mob/tools/gui/PullToRefreshAdatper;->onPullDown(I)V
...
.method public setAdapter(Lcom/mob/tools/gui/PullToRefreshAdatper;)V
    .locals 8
    .param p1, "adapter"    # Lcom/mob/tools/gui/PullToRefreshAdatper;
    ...
    iput-object v2, p0, Lcom/mob/tools/gui/PullToRefreshView;->bodyView:Landroid/view/View;
    ...
    iget-object v2, p0, Lcom/mob/tools/gui/PullToRefreshView;->bodyView:Landroid/view/View;

    invoke-virtual {p0, v2, v0}, Lcom/mob/tools/gui/PullToRefreshView;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {p1}, Lcom/mob/tools/gui/PullToRefreshAdatper;->getHeaderView()Landroid/view/View;

    move-result-object v2

    iput-object v2, p0, Lcom/mob/tools/gui/PullToRefreshView;->headerView:Landroid/view/View;

    iget-object v2, p0, Lcom/mob/tools/gui/PullToRefreshView;->headerView:Landroid/view/View;
    ...
    iput v2, p0, Lcom/mob/tools/gui/PullToRefreshView;->headerHeight:I
    ...
    invoke-virtual {p0, v2, v1}, Lcom/mob/tools/gui/PullToRefreshView;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method public stopPulling()V
    ...
    .local v0, "curTime":J
    iget-wide v4, p0, Lcom/mob/tools/gui/PullToRefreshView;->refreshTime:J
    ...
    iget-object v4, p0, Lcom/mob/tools/gui/PullToRefreshView;->stopAct:Ljava/lang/Runnable;

    sub-long v5, v6, v2

    invoke-virtual {p0, v4, v5, v6}, Lcom/mob/tools/gui/PullToRefreshView;->postDelayed(Ljava/lang/Runnable;J)Z
    ...
    invoke-virtual {p0, v4}, Lcom/mob/tools/gui/PullToRefreshView;->post(Ljava/lang/Runnable;)Z
